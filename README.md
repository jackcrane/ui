...
- `apps/ui-demo` – a lightweight Vite + React playground that consumes `@jackcrane/ui` from `packages/ui-kit/src` during local dev (for live updates) and renders the shared Blocks demos.
